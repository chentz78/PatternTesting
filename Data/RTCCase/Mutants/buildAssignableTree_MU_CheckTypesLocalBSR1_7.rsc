...
@bootstrapParser 
module buildAssignableTree_MU_CheckTypesLocalBSR1_7
...
public ATResult buildAssignableTree(Assignable assn:(Assignable)`<Assignable ar> [ <Expression sub> ]`, bool top, Configuration c) {
  ...
  throw "mutant! BSR1: Remove if conditionals. Case 1.";if (isRelType(atree@atype) && size(getRelFields(atree@atype)) == 2 && subtype(tsub,getRelFields(atree@atype)[0])) {
