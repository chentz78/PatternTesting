...
@bootstrapParser 
module checkStmt_MU_CheckTypesLocalBSR2_20
...
public CheckResult checkStmt(Statement stmt:(Statement)`break <Target target>;`, Configuration c) {
  println("checkStmt:4823");
    ...
    if (size(failures) > 0) throw "mutant! BSR2: Remove if conditionals. Case 2."; else return markLocationType(c, stmt@\loc, Symbol::\void());
}
