...
@bootstrapParser 
module checkStmt_MU_CheckTypesLocalBSR3_2
...
public CheckResult checkStmt(Statement stmt:(Statement)`<Expression e>;`, Configuration c) {
    ...
    if (isFailType(t1)) return markLocationFailed(c, stmt@\loc, t1); else throw "mutant! BSR3: Remove if conditionals. Case 3.";
}
