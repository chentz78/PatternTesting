...
@bootstrapParser 
module checkStmt_MU_CheckTypesLocalBSR2_15
...
public CheckResult checkStmt(Statement stmt:(Statement)`<Label lbl> if ( <{Expression ","}+ conds> ) <Statement bdy>`, Configuration c) {
  println("checkStmt:4653");
    ...
    if (size(failures) > 0) throw "mutant! BSR2: Remove if conditionals. Case 2."; else return markLocationType(c, stmt@\loc, Symbol::\value());    
}
