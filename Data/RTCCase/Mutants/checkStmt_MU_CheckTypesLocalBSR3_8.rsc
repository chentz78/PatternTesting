...
@bootstrapParser 
module checkStmt_MU_CheckTypesLocalBSR3_8
...
public CheckResult checkStmt(Statement stmt:(Statement)`<Label lbl> do <Statement bdy> while (<Expression cond>);`, Configuration c) {
  println("checkStmt:4505");
    ...
    if (isFailType(t1)) failures += t1; else throw "mutant! BSR3: Remove if conditionals. Case 3.";loopElementType = head(cDoWhile.labelStack).labelType;
