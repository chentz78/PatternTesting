...
@bootstrapParser 
module checkStmt_MU_CheckTypesLocalBSR3_26
...
public CheckResult checkStmt(Statement stmt:(Statement)`<Label lbl> { <Statement+ stmts> }`, Configuration c) {
  println("checkStmt:4948");
    ...
    if (isFailType(st)) return markLocationFailed(c, stmt@\loc, st); else throw "mutant! BSR3: Remove if conditionals. Case 3."; 
}
