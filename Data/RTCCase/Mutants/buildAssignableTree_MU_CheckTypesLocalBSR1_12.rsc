...
@bootstrapParser 
module buildAssignableTree_MU_CheckTypesLocalBSR1_12
...
public ATResult buildAssignableTree(Assignable assn:(Assignable)`<Assignable ar> [ <Expression sub> ]`, bool top, Configuration c) {
  ...
  throw "mutant! BSR1: Remove if conditionals. Case 1.";return < c, subscriptNode(atree,tsub)[@atype=(isMapType(atree@atype))?getMapRangeType(atree@atype):atree@atype][@at=assn@\loc] >;
    }
