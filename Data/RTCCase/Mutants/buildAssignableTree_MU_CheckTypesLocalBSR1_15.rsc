...
@bootstrapParser 
module buildAssignableTree_MU_CheckTypesLocalBSR1_15
...
public ATResult buildAssignableTree(Assignable assn:(Assignable)`<Assignable ar> [ <OptionalExpression optFirst> .. <OptionalExpression optLast> ]`, bool top, Configuration c) {
  ...
  throw "mutant! BSR1: Remove if conditionals. Case 1.";if (isFailType(atree@atype) || isFailType(tFirst) || isFailType(tLast))
