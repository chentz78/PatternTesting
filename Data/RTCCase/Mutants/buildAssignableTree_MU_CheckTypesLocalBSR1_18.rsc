...
@bootstrapParser 
module buildAssignableTree_MU_CheckTypesLocalBSR1_18
...
public ATResult buildAssignableTree(Assignable assn:(Assignable)`<Assignable ar> [ <OptionalExpression optFirst> .. <OptionalExpression optLast> ]`, bool top, Configuration c) {
  ...
  throw "mutant! BSR1: Remove if conditionals. Case 1.";if (isNodeType(atree@atype) && isIntType(tFirst) && isIntType(tLast))
